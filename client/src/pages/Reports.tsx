          ...
          <div className="bg-white dark:bg-neutral-900 border border-slate-150 dark:border-neutral-800 rounded-2xl shadow-sm p-6 space-y-6 relative overflow-hidden">
            ...
            {!isAiLoading && !aiError && advisorInsights && (
              <div className="space-y-6">
                ...
                {advisorInsights.isFallback && (
                  <div className="p-3.5 bg-amber-50/75 dark:bg-amber-950/15 border border-amber-200 dark:border-amber-900/35 rounded-xl text-amber-800 dark:text-amber-400 text-xs flex items-start gap-2.5">
